...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  for (const [loc, hreflang] of Object.entries(localeMap)) {
    languages[hreflang] = `${BASE_URL}/${loc}/services/restaurant`;
  }
  languages["x-default"] = `${BASE_URL}/sk/services/restaurant`;

  return {
    title: t("metaTitle"),
    description: t("metaDesc"),
    alternates: {
      canonical: `${BASE_URL}/${locale}/services/restaurant`,
      languages,
    },
    openGraph: {
      title: t("metaTitle"),
      description: t("metaDesc"),
      url: `${BASE_URL}/${locale}/services/restaurant`,
      siteName: "FormaInk",
          ...
          <ScrollReveal animation="fadeUp" delay={140}>
            <div className={styles.pricingSection}>
              ...
              <div className={styles.pricingGrid}>
                ...
                >
                  <p className={styles.pricingBadge}>{t("p5Name")}</p>
