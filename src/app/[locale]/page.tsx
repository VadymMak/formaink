...
export default async function HomePage({ params }: Props) {
  ...
  const services = [
    { key: 'brandIdentity', href: '/services/design' },
    { key: 'print', href: '/services/print' },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: 'FormaInk',
            url: BASE_URL,
            address: { '@type': 'PostalAddress', addressLocality: 'Trenčín', postalCode: '911 01', addressCountry: 'SK' },
            geo: { '@type': 'GeoCoordinates', latitude: 48.8945, longitude: 18.0444 },
            priceRange: '€€',
          }),
        }}
      />
          ...
          <ScrollReveal animation="fadeLeft">
            <div className={styles.heroText}>
              ...
              <div className={styles.heroCtas}>
                <Link href="/portfolio" className={styles.btnPrimary}>{tHero('cta')}</Link>
                <Link href="/contact" className={styles.btnSecondary}>{tHero('ctaSecondary')}</Link>
              </div>
            </div>
          </ScrollReveal>
          <ScrollReveal animation="fadeRight" delay={200}>
            <div className={styles.heroVisual}>
              <div className={styles.placeholder}>Portfolio Image</div>
            </div>
          </ScrollReveal>
        </div>
        <div className="container"><div className="accent-line" /></div>
      </section>
        ...
        <div className="container">
          ...
          <div className={styles.serviceGrid}>
            {services.map(({ key, href }, i) => (
              <ScrollReveal key={key} animation="fadeUp" delay={i * 100}>
                <Link href={href} className={styles.serviceCard}>
                  <h3 className={styles.serviceCardTitle}>{tServices(key as any)}</h3>
                  <p className={styles.serviceCardDesc}>{tServices(`${key}Desc` as any)}</p>
            ...
            <ScrollReveal animation="fadeLeft">
              <div className={styles.caseText}>
                ...
                <p className={`${styles.caseDesc} text-justified`}>
                  Trenčín &amp; Vienna — menu, labels, logos, complete visual identity.
                </p>
                <div className={styles.palette}>
                  <div className={styles.swatch} style={{ background: '#2D4A43' }} />
                  <div className={styles.swatch} style={{ background: '#D4A574' }} />
                  <div className={styles.swatch} style={{ background: '#F5F0E8' }} />
                  <div className={styles.swatch} style={{ background: '#8B3A2A' }} />
                </div>
                <Link href="/portfolio" className={styles.caseLink}>{tPortfolio('viewCase')} →</Link>
              </div>
            </ScrollReveal>
          ...
          <div className={styles.caseStudy}>
            <ScrollReveal animation="fadeLeft">
              <div className={styles.caseText}>
                ...
                <p className={`${styles.caseDesc} text-justified`}>
                  Food packaging with EU compliance — labels, brand identity, product line.
                </p>
                <div className={styles.palette}>
                  <div className={styles.swatch} style={{ background: '#E8C840' }} />
                  <div className={styles.swatch} style={{ background: '#1A5C3A' }} />
                  <div className={styles.swatch} style={{ background: '#FFFFFF', border: '1px solid #ccc' }} />
                  <div className={styles.swatch} style={{ background: '#333333' }} />
                </div>
                <Link href="/portfolio" className={styles.caseLink}>{tPortfolio('viewCase')} →</Link>
              </div>
            </ScrollReveal>
          ...
          <div className={styles.aboutGrid}>
            ...
            <ScrollReveal animation="fadeRight" delay={200}>
              <div className={styles.aboutPhoto}>
                <div className={styles.placeholder} style={{ minHeight: '400px' }}>Anastasia Photo</div>
              </div>
            </ScrollReveal>
          </div>
        </div>
          ...
          <div className={styles.testimonialGrid}>
            <ScrollReveal animation="fadeUp" delay={0}>
              <blockquote className={styles.quote}>
                <p>&ldquo;Professional approach and beautiful results. The menu design exceeded our expectations.&rdquo;</p>
                <cite>— Adriano Restaurant</cite>
              </blockquote>
            </ScrollReveal>
            <ScrollReveal animation="fadeUp" delay={150}>
              <blockquote className={styles.quote}>
                <p>&ldquo;Excellent packaging design with full EU compliance. Highly recommend.&rdquo;</p>
                <cite>— Star Food</cite>
              </blockquote>
            </ScrollReveal>
          </div>
      ...
      <section className={styles.ctaSection}>
        <div className="container" style={{ textAlign: 'center' }}>
          <ScrollReveal animation="scaleIn">
            ...
            <div className={styles.heroCtas}>
              <Link href="/contact" className={styles.btnPrimary}>{tCta('button')}</Link>
              <a href="https://wa.me/421XXXXXXXXX" className={styles.btnSecondary} target="_blank" rel="noopener noreferrer">WhatsApp</a>
            </div>
          </ScrollReveal>
        </div>
      </section>
